    ...
    while true do
        ...
        elseif choice == "99" then
            ...
            elseif spy_choice == "3" then
                ...
                shell.su("logcat -c")
                ui.info("Sekarang, silakan trigger Pebletz agar dia ME-LAUNCH / MEMBUKA gamenya (misal nyalakan Auto Rejoin).")
                ui.info("TUNGGU sampai jendela gamenya benar-benar terbuka di layar!")
                ui.info("Jika jendela game SUDAH TERBUKA, baru tekan [ENTER] di sini untuk melihat log-nya...")
                io.read("*l")
